  ...
  function initBlock(root) {
    ...
    async function callPreview() {
      ...
      try {
        ...
        const data = await postWithFallback("/apps/dogfaceart3/preview", "/apps/dogart/preview", fd);
    ...
    async function approve() {
      ...
      try {
        ...
        const data = await postWithFallback("/apps/dogfaceart3/finalize", "/apps/dogart/finalize", fd);
